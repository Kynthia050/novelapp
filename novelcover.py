...
def generate_comment_summary(base_summary, comments, novel_title: str = "") -> str:
    ...
    instructions = (
        "บทบาท: คุณคือผู้ช่วยสรุปความคิดเห็นผู้อ่านนิยายแบบไม่สปอยล์\n"
        "งานของคุณ: อ่านคอมเมนต์ทั้งหมด แล้วสรุปภาพรวมความรู้สึกและกระแสตอบรับของผู้อ่าน "
        "โดยห้ามเปิดเผยเนื้อหาสำคัญของเรื่อง\n"
        "กติกาห้ามสปอยล์ (สำคัญมาก):\n"
        "- ห้ามเล่าเหตุการณ์สำคัญ, เฉลยปม, ชื่อคนร้าย/ตัวตน, จุดหักมุม, ตอนจบ, "
        "หรือรายละเอียดฉากสำคัญ\n"
        "- ห้ามระบุชื่อเฉพาะที่เป็นสปอยล์ (ชื่อสถานที่ลับ/ความจริงที่ถูกเฉลย/รายละเอียดแผนการ)\n"
        "- ให้พูดเชิงภาพรวมเท่านั้น เช่น มีจุดหักมุม/มีปม/มีความเข้มข้นขึ้น แต่ห้ามบอกว่าเกิดอะไร\n"
        "- ถ้าคอมเมนต์มีสปอยล์ ให้ดูดซับเป็นอารมณ์ แล้วเขียนใหม่แบบไม่เปิดเผยรายละเอียด\n"
        "สิ่งที่ต้องสรุป:\n"
        "- โทนอารมณ์หลักของผู้อ่าน (ตื่นเต้น ซึ้ง ลุ้น หงุดหงิด อิน ฟิน ฯลฯ)\n"
        "- ประเด็นที่ถูกพูดถึงบ่อย (การเปิดเรื่อง/จังหวะเล่า/ตัวละคร/บรรยากาศ/ความเข้มข้น/ปมที่ชวนสงสัย)\n"
        "- สิ่งที่ชอบมาก และสิ่งที่อยากให้ปรับ (ถ้ามี) แต่ต้องไม่สปอยล์\n"
        "รูปแบบผลลัพธ์ (เขียนย่อหน้าเดียว 2-4 ประโยค):\n"
        "- เขียนให้เป็นภาษาไทยธรรมชาติ โทนเหมือนสรุปความเห็นนักอ่าน\n"
        "- ให้สรุปออกมาตามตัวอย่างด้านล่าง\n"
        "ตัวอย่างรูปแบบ (ให้เลียนแบบสไตล์นี้):\n"
        "นักอ่านส่วนใหญ่ตื่นเต้นกับการเปิดเรื่อง มีจุดหักมุมที่น่าสนใจ "
        "ตัวละครมีเป้าหมายของตัวเองชัด เนื้อหากำลังเข้มข้น ประทับใจมาก "
        "และยังสงสัยว่าปมต่าง ๆ จะพาเรื่องไปทางไหนต่อ"
    )
